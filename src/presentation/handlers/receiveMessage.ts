...
import { processContactMessage } from '../../application/services/contactMessageService';
...
export const handler: APIGatewayProxyHandler = async (event): Promise<APIGatewayProxyResult> => {
  ...
  try {
    await processContactMessage(parsedBody, clientIp);
    ...
    console.error('[receiveMessage] Unhandled error:', error);
